...
const captainController = __importStar(require("../controllers/captain.controller"));
...
router.get("/new-ride", authMiddleWare_1.captainAuth, captainController.waitForNewRide);
